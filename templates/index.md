...
<div class="row">
  <div class="main-content col-lg-9">
    <header class="mb-4">
      ...
      <div class="small">&raquo; <a class="text-secondary" href="/blogs/0">more posts</a></div>
    </header>
    <div class="row">
      <div class="col">
        {%- for item in collections.blogs -%}
          <article class="mb-5 position-relative">
            <div class="row">
              <div class="col-12 col-sm-4">
                <img class="w-100 rounded" src="{{item.data.thumbnail}}" alt="{{item.data.title}}">
    ...
    <article class="row mb-5">
      <div class="col">
        ...
        <time class="item-date small d-block text-muted mb-2" datetime="{{item.date}}">{{item.date}}</time>
        <h5>{{item.title}}</h5>
